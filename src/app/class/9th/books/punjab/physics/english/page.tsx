...
const data = {
  ...
  canonical: '/class/9th/books/punjab/physics/english',
  index: true,
  follow: true,
  image: '/opengraph-image.jpg',
  url: 'https://www.codebloglab.website/class/9th/books/punjab/physics/english',
  keywords: [
    'codebloglab Class 9 Punjab Board Physics Books English Medium',
    'Class 9 Punjab Board Physics Books English Medium codebloglab',
    'codebloglab Class 9 Punjab Board Physics Books English Medium',
    'Class 9 Punjab Board Physics Books English Medium codebloglab',
  ],
}
export default function page() {
  return (
    <>
      <SubHeader title="Class 9 Punjab Board Physics Books English Medium " />
      <Container>
