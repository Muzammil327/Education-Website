...
const data = {
  title: 'Class 9 Punjab Board Physics Books Urdu Medium',
  description:
  ...
  canonical: '/class/9th/books/punjab/physics/urdu',
  index: true,
  follow: true,
  image: '/opengraph-image.jpg',
  url: 'https://www.codebloglab.website/class/9th/books/punjab/physics/urdu',
  keywords: [
    'codebloglab Class 9 Punjab Board Physics Books Urdu Medium',
    'Class 9 Punjab Board Physics Books Urdu Medium codebloglab',
    'codebloglab Class 9 Punjab Board Physics Books Urdu Medium',
    'Class 9 Punjab Board Physics Books Urdu Medium codebloglab',
  ],
}
export default function page() {
  return (
    <>
      <SubHeader title="Class 9 Punjab Board Physics Books Urdu Medium " />
