...
const data = {
  title: 'Class 9 Punjab Board Chemistry Books',
  description:
  ...
  canonical: '/class/9th/books/punjab/chemistry',
  index: true,
  follow: true,
  image: '/opengraph-image.jpg',
  url: 'https://www.codebloglab.website/class/9th/books/punjab/chemistry',
  keywords: [
    'codebloglab Class 9 Punjab Board Chemistry Books',
    'Class 9 Punjab Board Chemistry Books codebloglab',
    'codebloglab Class 9 Punjab Board Chemistry Books',
    'Class 9 Punjab Board Chemistry Books codebloglab',
  ],
}
...
export default function page() {
  return (
    <>
      <SubHeader title="Class 9 Punjab Board Chemistry Books" />
      <Container>
